...
export default function validation (userData){
    ...
    else if(userData.username.length>35) errors.username='El nombre de usuario no puede tener más de 35 caracteres.';

    if(!regexPassword.test(userData.password)) errors.password='La contraseña debe tener al menos un número';
    else if(userData.password.length <5 && userData.password.length >10) errors.password='La contraseña tiene que tener una longitud entre 6 y 10 caracteres.';
